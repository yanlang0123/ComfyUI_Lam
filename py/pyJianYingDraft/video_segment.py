...
class Video_segment(Visual_segment):
    ...
    def __init__(self, material: Union[Video_material, str], target_timerange: Timerange, *,
        ...
        """
        self.data_for_meta_info=self.get_material_for_meta_info()
        self.data_for_meta_info['metetype'] = material.material_type
        self.data_for_meta_info['width'] = material.width
        self.data_for_meta_info['height'] = material.height
        self.data_for_meta_info['duration'] = material.duration
        self.data_for_meta_info['extra_info'] = material.material_name
        self.data_for_meta_info['file_Path'] = material.path
    ...
    def add_animation(self, animation_type: Union[Intro_type, Outro_type, Group_animation_type],
        ...
        Args:
            ...
            duration (`int` or `str`, optional): 动画持续时间, 单位为秒. 若传入字符串则会调用`tim()`函数进行解析.
